    ...
    <section className="relative min-h-screen overflow-hidden pt-16">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        >
          ...
          >
            <a href="mailto:niederejulien@hotmail.com">
        ...
        <motion.a
          ...
          className="absolute bottom-8 flex h-10 w-10 items-center justify-center rounded-full border border-white/30 text-white/60 hover:bg-white/10 transition-colors"
        >
